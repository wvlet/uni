...
/**
 * Describes how a cross-project's directories are laid out: where each platform's sbt project lives
 * and where the sources shared across platforms live.
 */
...
object CrossType:
  ...
  object Pure extends CrossType:
    ...
    override def sharedResourcesDir(projectBase: File, conf: String): Option[File] =
